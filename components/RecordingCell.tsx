...
/*
 * The upload transport (`postWithProgress`), the duration probe, and the two
 * formatters used to live here. They moved to `./recordingUpload` when the
 * lead workspace grew a recording panel that posts to the same endpoint — see
